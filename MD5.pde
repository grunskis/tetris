...
class MD5 {
  ...
  private final byte[] encode( final int input[], final int len) {
    int i, j;
    byte out[];
    out = new byte[len];
   ...
   * 	 * @return String of this object's hash
   	 */
  public final String toHex( final byte[] hash ) {
  ...
  public final String toBase64( final byte[] data ) {
   ...
   * 	 *         equal.
   	 */
  public final boolean equals(byte[] hash1, byte[] hash2) {
    if (hash1 == null)
      return hash2 == null;
    if (hash2 == null)
      return false;
